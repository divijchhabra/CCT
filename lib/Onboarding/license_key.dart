...
class _License_KeyState extends State<License_Key> {
  ...
  var licenseCntroller = new MaskedTextController(mask: '@@@@-@@@@-@@@@-@@@@');
  ...
  void getData() async {
    NetworkHelper networkHelper =
        NetworkHelper('https://api.hyper.co/v6/licenses/${licenseCntroller.text}');
    print('https://api.hyper.co/v6/licenses/${licenseCntroller.text}');
              ...
              child: Column(
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: button(
                      onPressed: () {
                        if (licenseCntroller.text.isEmpty == true) {
                          ScaffoldMessenger.of(context).showSnackBar(
                            SnackBar(
                              content: Text(
